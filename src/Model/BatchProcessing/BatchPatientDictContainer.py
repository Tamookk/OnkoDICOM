class BatchPatientDictContainer:
    """
    This class is a non-singleton version of PatientDictContainer
    It's primary use is intended for Batch Processing operations
    """
